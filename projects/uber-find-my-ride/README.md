...
- An initial public internet-research sweep has been completed and documented; targeted local verification remains.
...
**Initial internet research is documented; targeted validation and interviews remain.** See [`PROJECT_STATUS.md`](PROJECT_STATUS.md) for the active tracker.
